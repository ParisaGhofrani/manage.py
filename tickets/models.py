...
from django.utils.text import slugify, capfirst  # Capfirst
from .choices import *
...
class Assignment(TimestampedModel):
    ...
    seen_at = models.DateTimeField(null=True, blank=True, help_text="When this assignment was seen by assignee?}")
